...
def build_selected_evidence_model(page: dict[str, Any] | WikiPage | None, *, context_section: str = "") -> dict[str, Any]:
    ...
    return {
        ...
        "report_citation": normalized.get("report_citation") or "",
        "wiki_schema_version": core_wiki._safe_count(normalized.get("wiki_schema_version"), 1, 10),
        "parent_page_id": normalized.get("parent_page_id") or "",
...
def _normalize_page(page: dict[str, Any] | WikiPage) -> dict[str, Any]:
    ...
    if {"title", "summary", "body", "verification_status", "source_refs", "openQuestions"}.intersection(page):
        ...
        normalized = {
            ...
            "report_citation": _clean(page.get("report_citation") or core_wiki._extract_report_citation(page.get("body")), 600),
            "wiki_schema_version": core_wiki._safe_count(page.get("wiki_schema_version"), 1, 10),
