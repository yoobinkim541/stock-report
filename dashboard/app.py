...
nav = st.navigation([
    ...
    st.Page(ticker_pg.render, title="종목 분석", icon="🔍", url_path="ticker"),
    st.Page(market.render, title="시장·캘린더", icon="🗓️", url_path="market"),
    st.Page(research.render, title="리서치", icon="🔬", url_path="research"),
])
nav.run()
