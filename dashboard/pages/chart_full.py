...
def render():
    ...
    _chart = (ticker_pg._price_chart_replay if st.session_state.get("_chart_replay_playing")
              else (ticker_pg._price_chart_live if live else ticker_pg._price_chart_frag))
