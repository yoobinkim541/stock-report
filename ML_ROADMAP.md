...
| (신규) 레짐 코어(N): 앙상블추세(MA50~250 투표)×vol타깃25%×VIX텀 + 방어슬리브 SGOV/GLD 50:50 | ⭐⭐⭐⭐ | ★★☆ | 🟡 백테스트 검증 완료 (16y CAGR 23.1% vs QQQ 19.6%, MDD -28.2% vs -35.1%, Sharpe 0.81/Calmar 0.82 전변형 최고; 고금리 2022+ 전지표 우위. backtest/regime_core_backtest.py) — paper_track 3번째 암으로 실데이터 검증 중, 60일+ 후 실전 슬리브 전환 판단. 기각: 절대모멘텀(K, MDD↑)·카나리아(M, 상승장 과도 축소). 주의: GLD 기여는 2010s초·2024+ 금 강세 의존 — 금 약세장(2013~15) 구간 점검 필요 |
