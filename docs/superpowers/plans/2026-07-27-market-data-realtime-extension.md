...
>
> 계획서에 선언된 파일(Create/Modify/Test) 7개가 전부 코드베이스에 존재함을 확인했고,
...
- [x] **Step 2: Run test to verify it fails or confirms current behavior**
...
- [x] **Step 3: Add read-only broker fetcher only after live endpoint shape is proven**
...
- [x] **Step 3: Implement session classifier and cache metadata**
...
- [x] **Step 2: Run live collector smoke**
