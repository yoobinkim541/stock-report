...
- [ ] **Step 4: Wire identity into append/load**
...
- [ ] **Step 1: Write failing persistence-health tests**
...
- [ ] **Step 3: Add cross-process locking and manifests**
...
- [ ] **Step 4: Extend health without breaking old files**
...
- [ ] **Step 4: Make the old collector CLI a compatibility entrypoint**
...
- [ ] **Step 3: Implement batch-first fetching**
...
- [ ] **Step 3: Implement calendar and cache adapters**
...
- [ ] **Step 4: Register calendar collection and context exposure**
...
- [ ] **Step 3: Replace the monolithic source cron**
...
- [ ] **Step 4: Implement and run drift check**
...
- [ ] **Step 5: Apply the checked-in crontab and verify**
