...
- [x] **Step 1: Write the regression check**
...
- [x] **Step 3: Delete the unused page file**
...
- [x] **Step 1: Write the behavior tests**
...
- [x] **Step 2: Replace the tab bar with sections**
...
- [x] **Step 3: Merge memory and wiki into one drawer**
...
- [x] **Step 4: Fold advanced tools behind one expander**
...
- [x] **Step 5: Trim the fast prompts**
...
- [x] **Step 2: Remove stale references**
...
- [x] **Step 3: Run the final verification pass**
