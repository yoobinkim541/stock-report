...
>
> 계획서에 선언된 파일(Create/Modify/Test) 17개가 전부 코드베이스에 존재함을 확인했고,
...
- [x] **Step 1: Write failing tests for preference normalization and the full selection matrix**
...
- [x] **Step 2: Run focused tests and confirm missing contract failures**
...
- [x] **Step 3: Implement renderer validation, safe patching, decision reasons, and toolbar segmented control**
...
- [x] **Step 5: Commit the backend contract**
...
- [x] **Step 2: Run payload tests and confirm import failure**

Run: `.venv/bin/pytest -q tests/test_lightweight_embed.py`

Expected: import failure for `dashboard.lightweight_embed`.

- [x] **Step 3: Implement the payload serializer and standalone HTML component**
...
- [x] **Step 4: Add a Node runtime harness**
...
- [x] **Step 4: Wire workspace and compact panels**
...
- [x] **Step 5: Run page and chart regressions**
...
- [x] **Step 1: Add deterministic performance gates**
...
- [x] **Step 2: Run focused and full chart regressions**
...
- [x] **Step 3: Start the dashboard and verify desktop/mobile browser behavior**
...
- [x] **Step 5: Commit, push, and restart affected services**
